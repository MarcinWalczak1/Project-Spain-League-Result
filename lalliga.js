...
const API_URL = `https://api-football-v1.p.rapidapi.com/v3/standings?season=2022&league=140`;
...
const teamsName = new elementCreation('teams-table', 'teams-name' );
const teamsLogo = new elementCreation('teams-logo', "logo-list", "logo-image" )
const listPlace = new elementCreation('teams-rank', 'number-rank');
const goalList = new elementCreation('goals', 'list-goal');
const matchList = new elementCreation('matches-count', 'list-match');
const pointsList = new elementCreation('teams-points', 'list-points');
