const API_URL_Segunda = `https://api-football-v1.p.rapidapi.com/v3/standings?season=2022&league=141`;


fetch(API_URL_Segunda, options)
...
const teamsName = new elementCreation('segunda-teams-table', 'teams-name' );
const teamsLogo = new elementCreation('segunda-teams-logo', "logo-list", "logo-image" )
const listPlace = new elementCreation('segunda-teams-rank', 'number-rank');
const goalList = new elementCreation('segunda-goals', 'list-goal');
const matchList = new elementCreation('segunda-matches-count', 'list-match');
const pointsList = new elementCreation('segunda-teams-points', 'list-points');
