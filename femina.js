const API_URL_Femina = `https://api-football-v1.p.rapidapi.com/v3/standings?season=2022&league=142`;


fetch(API_URL_Femina, options)
...
const teamsName = new elementCreation('femina-teams-table', 'teams-name' );
const teamsLogo = new elementCreation('femina-teams-logo', "logo-list", "logo-image" )
const listPlace = new elementCreation('femina-teams-rank', 'number-rank');
const goalList = new elementCreation('femina-goals', 'list-goal');
const matchList = new elementCreation('femina-matches-count', 'list-match');
const pointsList = new elementCreation('femina-teams-points', 'list-points');
